...
const GameCard = ({ game, isMobile, imageLoadingStates, setImageLoadingStates, setSelectedGame, category, filterCategory }) => {
  ...
  return (
    ...
    >
      {/* Game Image */}
      <div style={{ position: "relative", height: "180px", background: "rgba(0, 0, 0, 0.3)", overflow: "hidden" }}>
        {isLoading && (
          <div
            style={{
              width: "100%",
      ...
      <div style={{ padding: "1rem" }}>
        ...
        {game.pricing && game.pricing.length > 0 && (
          ...
          >
            <div style={{ color: "#00ff88", fontSize: "0.75rem", fontWeight: "bold", marginBottom: "0.3rem" }}>
              Starting from:
            </div>
